            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3">
                <form action="{{ route('project.update', $project->id) }}" method="post">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input id="weight" type="number" class="mt-1 block w-full" autocomplete="weight" name="weight" value="{{ $project->weight }}"/>
                        <x-jet-input-error for="weight" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-label for="age" value="{{ __('Edad') }}" />
                        <x-jet-input id="age" type="number" class="mt-1 block w-full" autocomplete="age" name="age" value="{{ $project->age }}"/>
